 ...
 * @var \Cake\Datasource\EntityInterface[]|\Cake\Collection\CollectionInterface $listingsCategories
 */
?>
...
<div class="listingsCategories index large-9 medium-8 columns content">
    <h3><?= __('Listings Categories') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($listingsCategories as $listingsCategory): ?>
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $listingsCategory->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $listingsCategory->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $listingsCategory->id], ['confirm' => __('Are you sure you want to delete # {0}?', $listingsCategory->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
