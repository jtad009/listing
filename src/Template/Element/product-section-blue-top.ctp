    ...
    <div class="col-md-10 mx-auto   " data-aos="zoom-in">
        <div class="row">
            ...
            <div class="col-md-12 col-lg-6" style="align-items: flex-end;display: flex;">
                ...
                <?= $this->Html->image($image, ['class' => "d-block d-lg-none   w-100 img-fluid"]) ?>
                ...
                <div class=" b-card3  text-justify" style="background: transparent !important;">
                    ...
                    <p class="d-flex">
                        <a href="#calculator" class="btn btn-primary-outline text-center mr-3">CALCULATE
                            REWARDS</a>
                        <a href="https://apply.doubble.ng/" target="_blank" class="ml-3 btn btn-primary text-center" data-aos="zoom-in">START
                            INVESTING</a>
                    </p>
                </div>
            </div>
